...
export default function Layout() {
    return (
      <div className="bg-green-200 min-h-screen">
        ...
        {/* header */}
        <div className="absolute bg-white text-blue-800 px-10 py-1 z-10 w-full">
          <div className="flex items-center justify-between py-2 text-5x1">
            <div className="font-bold text-green-900 text-xl">
              Denplan<span className="text-green-600">Logo</span>
            </div>
        ...
        {/* banner */}
        <div className="absolute bg-blue-500 text-white px-10 py-1 z-10 w-full mt-16">
          <div className="flex items-center justify-center py-4 text-5x1">
            <span className="text-xl">Welcome to Denplan!</span>
          </div>
        </div>

        {/* search bar */}
        <div className="absolute bg-pink-500 text-white px-10 py-1 z-10 w-full mt-32">
          <div className="flex items-center justify-center py-2 text-5x1">
            <input
              type="text"
              className="text-black p-2 rounded-lg w-1/2"
              placeholder="Search..."
            />
          </div>
        </div>
        ...
        <div className="flex flex-row pt-56 px-10 pb-4">
